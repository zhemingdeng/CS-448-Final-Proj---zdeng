...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  private TextView ocrResultViewIsTrue;
  ...
  public void onCreate(Bundle icicle) {
    ...
    ocrResultViewIsTrue=(TextView)findViewById(R.id.result_view_is_true);
    registerForContextMenu(ocrResultViewIsTrue);
  ...
  boolean handleOcrDecode(final OcrResult ocrResult) {
    ...
    TextView ResultIsTrueTextView=(TextView)findViewById(R.id.result_view_is_true);
    ResultIsTrueTextView.setText("Click if result is correct");
    ResultIsTrueTextView.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
         Intent i=NavigationActivity.newIntent(CaptureActivity.this, ocrResult.getText().toString());
         startActivity(i);
      }
    });
